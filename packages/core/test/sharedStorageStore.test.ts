...
const CLOCK_MS = 1_800_000_000_000; // after every export in this file
const NOW = 1_800_000_100;
const WARBAND_KEY = "retail::warband::local";
const VIREK_KEY = "retail::cairne::virek";
...
const T = 1_790_000_000; // base observation time
const mats = (qty = 5): Array<[string, number]> => [["Linen Cloth", qty]];
const WIDE: TabSpec[] = [
...
function normalized(p: SharedStorageProjection): string {
